...
<div class="titlepage mt-2 ml-3">TOURIST GUIDE
  <i class="fas fa-globe-americas america ml-2"></i><span class="titles ml-2">Thailand</span>
    ...
    <button class=" btn btn-link addguide mt-4" onclick="document.getElementById('add').style.display='block'"><i class="fas fa-plus-square "></i></button>
  </div>
  <div class="container">
      ...
      <div class="row mt-5">
              <div class="col-md-4">
                <div class="card mb-4 shadow-sm"  style="background-color: #f48fb1 ">
                  <svg class="bd-placeholder-img card-img-top" width="100%" height="500" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img"><rect fill="#F1948A" width="100%" height="100%"></rect><image xlink:href="{{url('gallery/thai-som-tum.jpg.jpg')}}" y="0%" x="-80%" width="900"></image></svg>
                  <div class="card-body">
      ...
      <div class="col-md-4">
              <div class="card mb-4 shadow-sm" style="background-color: #f48fb1 ">
                  <svg class="bd-placeholder-img card-img-top" width="100%" height="500" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img"><rect fill="#F1948A" width="100%" height="100%"></rect><image xlink:href="{{url('gallery/tHO98STFIB.jpg')}}" y="-5%" x="-25%" width="935px"></image></svg>
                        <div class="card-body">
                    ...
                    <div class="col-md-4">
                          <div class="card mb-4 shadow-sm" style="background-color: #f48fb1 ">
                            <svg class="bd-placeholder-img card-img-top" width="100%" height="500" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img"><rect  fill="#F1948A" width="100%" height="100%"></rect><image xlink:href="{{url('gallery/595aecb0377ed66c5a707e5a6aae07ea.jpg')}}" y="0%" x="-57%" width="720px"></image></svg>
                            <div class="card-body">
      ...
      <div class="w3-modal-content w3-card-4" style="background-color:#F2D7D5">
        ...
        <?php if($guide->type == 'food') { ?>
            ...
            <div style="text-align: right;" role="group">
                  ...
                  <button class="editprofile btn btn-link" onclick="document.getElementById('editguide').style.display='block'">
 ...
 <div id="add" class="w3-modal">
            ...
            <div class="w3-container w3-border-top w3-padding-16" style="background-color:#F2D7D5">
                <button onclick="document.getElementById('add').style.display='none'" type="button" class="btn btn-danger">Cancel</button>
            </div>
  ...
  <div id="editguide" class="w3-modal">
            <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px;background-color:#F2D7D5">
            ...
            <div class="w3-container w3-border-top w3-padding-16" style="background-color:#F2D7D5">
                <button onclick="document.getElementById('editguide').style.display='none'" type="button" class="btn btn-danger">Cancel</button>
            </div>
